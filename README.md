...
`python lstm_inference.py --input_file molecules_for_prediction.csv  --output_dir ../../results/prediction_results --model_name ../../results/serialized_models/lstm_target_mac_50_model.pt`
