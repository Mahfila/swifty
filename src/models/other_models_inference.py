...
parser.add_argument("--model_id", type=str, help="model_id is the serialized model such as "
                                                 "sgdreg_test_500_mac_50_model.pkl")
args = parser.parse_args()

if __name__ == '__main__':
    OtherModels.inference(args.input_file, args.output_dir, args.model_id)
