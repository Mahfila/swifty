...
parser.add_argument("--model_id", type=str, help="model_id is the serialized model such as lstm_test_mac_10_model")
args = parser.parse_args()

if __name__ == '__main__':
    SwiftDock.inference(args.input_file, args.output_dir, args.model_id)
